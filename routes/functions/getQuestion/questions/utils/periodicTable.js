...
const periodicTable = [
  ...
  },
  {
    ...
    "cpk-hex": "c70066",
    isotopes: [258, 259, 260],
  },
];

module.exports = {
  findByNumber: (atomicNumber) => {
    if (atomicNumber < 0 || atomicNumber >= periodicTable.length) {
      throw new Error("AtomicNumberOutOfRangeError");
    } else {
      return periodicTable.find((element) => element.number === atomicNumber);
    }
  },
  ...
  getRandomElement: () => {
    return periodicTable[r.int(0, periodicTable.length - 1)];
  },
};
