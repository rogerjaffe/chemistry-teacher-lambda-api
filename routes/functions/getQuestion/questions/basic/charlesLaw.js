...
const charlesLaw = () => {
  ...
  return {
    questionPayload: {
      ...
      skeletonCount: 7,
      title: `<h6>
          Charles Law states that under conditions of constant pressure and quantity, there is a direct relationship between the volume and absolute temperature for an ideal gas. Calculate the missing quantity, paying close attention to all of the dimensions. 
        </h6>`,
    },
    answerPayload: [
      {
